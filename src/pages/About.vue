  ...
  <div class="twinkling">
    ...
    <div class="about__main">
      <b-row class="justify-content-md-center">
        <b-col sm="3">
          <img src="../img/aboutus_img/aboutus_methodical.png" alt="image" class="about__main-img"/><br>
          <div class="about__main-text-hidden"><span style="color: #58F86F">Our expertise</span>
        ...
        <b-col sm="3">
          <img src="../img/aboutus_img/aboutus_analytical.png" alt="image" class="about__main-img"/><br>
          <div class="about__main-text-hidden"><span style="color: #58F86F"> Our passion</span>
        ...
        <b-col sm="3">
          <img src="../img/aboutus_img/aboutus_impactful.png" alt="image" class="about__main-img"/><br>
          <div class="about__main-text-hidden"><span style="color: #58F86F"> Our focus</span> 
